...
<ul>Get a single recipe.<br/>
  ...
  <li>Error Response<br>
    Code: 404 NOT FOUND<br />
    Content: <code>Folder with id ${recipe.id} not found.</code>
  </li>
  <li>Sample Call:
...
<ul>
  ...
  <li>Sample Call:
    <code>return fetch(`${config.API_ENDPOINT}/lists`, {<br>
      headers: {<br>
      },<br>
    })<br>
      .then(res => <br>
  ...
  <li>Success Response<br>
    Code: 201<br />
    Content: <code>List with id ${list.id} created.</code>
  </li>
  <li>Error Response<br>
    Code: 400<br />
    Content: <code>error: { message: `Missing '${field}' in request body` }</code>
  </li>
  <li>Sample Call:
    <code>return fetch(`${config.API_ENDPOINT}/lists`, {<br>
      headers: {<br>
  ...
  <h3>Get a Grocery List by ID</h3>
<ul>Get a single list.<br/>
  <li>URL<br/>
    /lists/:list_id
  </li>
  <li>Method:<br/>
  ...
  <li>Success Response<br>
    Code: 200<br />
    Content: <code>{"id":2,"name":"Potluck","items":"Carrots, Cabbage, Ice cream, Lemon bars, Coffee"}</code>
  </li>
  <li>Error Response<br>
    Code: 404 NOT FOUND<br />
    Content: <code>List with id ${list.id} not found.</code>
  </li>
  <li>Sample Call:
    <code>return fetch(`${config.API_ENDPOINT}/lists/${list_id}`, {
      headers: {
      },
    })
      .then(res =>
